 ...
 */
public class SpecialEfficacyActivity extends BaseActivity implements ViewSwitcher.ViewFactory, View.OnClickListener {
    public static final String TAG = "SpecialEfficacyActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        textSwitcher.setInAnimation(AnimationUtils.loadAnimation(this, R.anim.notice_scroll_top_to_down_current_text));
        textSwitcher.setOutAnimation(AnimationUtils.loadAnimation(this, R.anim.notice_scroll_top_to_down_next_text));
        Timer timer = new Timer();
        timer.scheduleAtFixedRate(new MyTask(), 1, 3000);// 每3秒更新


        btn_count_down_timer = (Button) findViewById(R.id.btn_count_down_timer);
