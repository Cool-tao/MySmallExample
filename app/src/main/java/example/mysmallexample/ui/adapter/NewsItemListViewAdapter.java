...
//
//    public NewsItemListViewAdapter(Context context, OnClickListener onClickListener, boolean isNewsitemUnlike) {
...
//        if (ads == null || Const.isSaveMode()) {
//            nextAdPosition = MAX_POSITION * 2;
//            return;
//        }
...
//                break;
//            case TYPE_VEDIO://视频
//                convertView = inflater.inflate(R.layout.news_vedio_item_layout, parent, false);
//                viewHolder = new VHVedio(convertView);
//                break;
//            case TYPE_AD://广告
//                convertView = inflater.inflate(
...
//                    break;
//                case TYPE_VEDIO:
//                    VHVedio vhVedio = (VHVedio) holder;
//                    bean = list.get(position);
//                    vhVedio.jcVideoPlayer.setUp(bean.getJson_url(), bean.getTitle());
//                    SPUtil.displayImage(bean.getImgs()[0], vhVedio.jcVideoPlayer.ivThumb, DisplayOptionFactory.Big.options);
//                    String from;
//                    String fav;
//                    String comcount;
//                    if (isNewsitemUnlike) {
//                        vhVedio.newsitem_unlike.setVisibility(View.VISIBLE);
//                    }
//                    vhVedio.newsitem_unlike.setOnClickListener(new popAction(bean, position));
//                    SPUtil.setAtt(vhVedio.item_type_iv, bean.getAttname());
//                    from = bean.getCopyfrom();
//                    if (!TextUtils.isEmpty(from)) {
//                        vhVedio.newsitem_source.setText(from);
//                        vhVedio.newsitem_source.setVisibility(View.VISIBLE);
//                    } else {
//                        vhVedio.newsitem_source.setVisibility(View.GONE);
//                    }
//                    fav = bean.getFav();
//                    if (!TextUtils.isEmpty(fav)) {
//                        int fav_counts = Integer.parseInt(fav);
//                        if (fav_counts > 0) {
//                            vhVedio.newsitem_collectcount.setVisibility(View.VISIBLE);
//                            vhVedio.newsitem_collectcount.setText(fav_counts + "");
//                        } else {
//                            vhVedio.newsitem_collectcount.setVisibility(View.GONE);
//                        }
//                    } else {
//                        vhVedio.newsitem_collectcount.setVisibility(View.GONE);
//                    }
...
//                        if (counts > 0) {
//                            vhVedio.newsitem_commentcount.setVisibility(View.VISIBLE);
//                            bean.setComcount(counts + "");
//                            vhVedio.newsitem_commentcount.setText(counts + "");
//                        } else {
//                            vhVedio.newsitem_commentcount.setVisibility(View.GONE);
//                        }
//                    } else {
//                        vhVedio.newsitem_commentcount.setVisibility(View.GONE);
//                    }
...
//                        vhVedio.newsitem_time.setText("");
//                    } else {
//                        vhVedio.newsitem_time.setText(CalendarUtil.friendlyTime(bean.getUpdate_time(), context));
//                    }
//
//
//                    break;
...
//        jokeHolder.joke_good_layout.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
...
//            }
//        });
//        jokeHolder.joke_bad_layout.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if (!isJokeBad) {//点赞操作
...
//        }
//        jokeHolder.joke_comment_counts_layout.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
...
//        private View[] item;
//
//        public HotSearch(View v) {
//            super(v);
//            title = new TextView[6];
//            title[0] = (TextView) v.findViewById(R.id.line1).findViewById(R.id.title1);
//            title[1] = (TextView) v.findViewById(R.id.line1).findViewById(R.id.title2);
//            title[2] = (TextView) v.findViewById(R.id.line2).findViewById(R.id.title1);
//            title[3] = (TextView) v.findViewById(R.id.line2).findViewById(R.id.title2);
//            title[4] = (TextView) v.findViewById(R.id.line3).findViewById(R.id.title1);
//            title[5] = (TextView) v.findViewById(R.id.line3).findViewById(R.id.title2);
//            item = new View[6];
//            item[0] = v.findViewById(R.id.line1).findViewById(R.id.item1);
//            item[1] = v.findViewById(R.id.line1).findViewById(R.id.item2);
//            item[2] = v.findViewById(R.id.line2).findViewById(R.id.item1);
//            item[3] = v.findViewById(R.id.line2).findViewById(R.id.item2);
//            item[4] = v.findViewById(R.id.line3).findViewById(R.id.item1);
//            item[5] = v.findViewById(R.id.line3).findViewById(R.id.item2);
////            v.setOnClickListener(onClickListener);
//        }
//    }
//
//    private class MyAD extends RecyclerView.ViewHolder {
//
//        public MyAD(View v) {
//            super(v);
////            v.setOnClickListener(onClickListener);
...
//    }
//
//    private class VHVedio extends RecyclerView.ViewHolder {
...
//        private View newsitem_unlike;
//        private ImageView item_type_iv;
//        public VHVedio(View v) {
//            super(v);
//            jcVideoPlayer = (JCVideoPlayerStandard) v.findViewById(R.id.videoplayer);
//            newsitem_title = (TextView) v.findViewById(R.id.newsitem_title);
//            nli_foot = (ImageView) v.findViewById(R.id.nli_foot);
//            newsitem_source = (TextView) v.findViewById(R.id.newsitem_source);
//            newsitem_collectcount = (TextView) v.findViewById(R.id.newsitem_collectcount);
...
//                dislike_tv.setOnClickListener(new OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
